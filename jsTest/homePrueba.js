...
try {
    ...
    console.log("Error attaching event listener to 'menu':", error);
}
...
try {
    ...
    console.log("Error attaching event listener to 'log_icon':", error);
}
...
try {
    ...
    console.log("Error attaching event listener to 'palanca':", error);
}
try{
    ...
    console.log("Error attaching event listener to 'puko':", error);
}
try{
    ...
    console.log("Error attaching event listener to 'avaliable_auction':", error);
}
